...
use Bio::Moose;
use Bio::Moose::Location::WidestCoordPolicy;
use Bio::Moose::Types qw/SequenceStrand Int Str/;

with 'Bio::Moose::Role::LocationI';

our $coord_policy = Bio::Moose::Location::WidestCoordPolicy->new();
...
has 'coordinate_policy' => (
	is => 'rw', 
	isa => 'Bio::Moose::Role::Location::CoordinatePolicy', 
	default => sub { Bio::Moose::Location::WidestCoordinatePolicy->new() }, 
);
