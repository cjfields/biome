package Biome::SeqRecord;

use Biome;
use namespace::clean -except => 'meta';

with 'Biome::Role::SeqRecord';
with 'Biome::PrimarySeqContainer';
...
Biome::SeqRecord - <One-line description of module's purpose>

=head1 VERSION

This documentation refers to Biome::SeqRecord version Biome.
