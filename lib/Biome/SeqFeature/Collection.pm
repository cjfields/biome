package Biome::SeqFeature::Collection;

use Biome;
use namespace::clean -except => 'meta';

with 'Biome::Role::SeqFeature::Collection';
...
Biome::SeqFeature::Collection - <One-line description of module's purpose>

=head1 VERSION

This documentation refers to Biome::SeqFeature::Collection version Biome.

=head1 SYNOPSIS

   use Biome::SeqFeature::Collection;
