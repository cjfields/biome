...
Biome::Role::Location::Stranded - Very simple role for indicating something has
a strand attribute (i.e. DNA)
...
Just a simple role containing one attribute, 'strand'.  May be turned into a
trait, so beware.
