package Biome::Role::CoordinateStore;

use Biome::Role;
use namespace::clean -except => 'meta';

requires qw(store objects_in_range);
...
Biome::Role::CoordinateStore - <One-line description of module's purpose>

=head1 VERSION

This documentation refers to Biome::Role::CoordinateStore version Biome::Role.

=head1 SYNOPSIS

   with 'Biome::Role::CoordinateStore';
