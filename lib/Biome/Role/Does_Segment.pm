...
Biome::Role::Does_Segment - <One-line description of module's purpose>

=head1 VERSION

This documentation refers to Biome::Role::Does_Segment version Biome::Role.

=head1 SYNOPSIS

   with 'Biome::Role::Does_Segment';
