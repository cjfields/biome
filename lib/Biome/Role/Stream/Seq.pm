...
Biome::Role::Stream::Seq - <One-line description of module's purpose>

=head1 VERSION

This documentation refers to Biome::Role::Stream::Seq version Biome::Role.
