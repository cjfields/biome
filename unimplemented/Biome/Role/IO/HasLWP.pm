...
Biome::Role::IO::HasLWP - <One-line description of module's purpose>

=head1 VERSION

This documentation refers to Biome::Role::IO::HasLWP version Biome::Role.

=head1 SYNOPSIS

   with 'Biome::Role::IO::HasLWP';
