package Biome::Role::IO::HasFileTemp;
...
Biome::Role::IO::HasFileTemp - <One-line description of module's purpose>

=head1 VERSION

This documentation refers to Biome::Role::IO::HasFileTemp version Biome::Role.

=head1 SYNOPSIS

   with 'Biome::Role::IO::HasFileTemp';
