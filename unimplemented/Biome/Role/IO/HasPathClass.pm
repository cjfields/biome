package Biome::Role::IO::HasPathClass;
...
Biome::Role::IO::HasPathClass - <One-line description of module's purpose>

=head1 VERSION

This documentation refers to Biome::Role::IO::HasPathClass version Biome::Role.

=head1 SYNOPSIS

   with 'Biome::Role::IO::HasPathClass';
