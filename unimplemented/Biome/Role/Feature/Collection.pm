package Biome::Role::Feature::Collection;
...
Biome::Role::Feature::Collection - simple role that collects any Feature
implementations.

=head1 VERSION

This documentation refers to Biome::Role::Feature::Collection version 0.01.

=head1 SYNOPSIS

   use Biome::Role::Feature::Collection;
